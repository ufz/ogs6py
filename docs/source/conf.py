...
# -*- coding: utf-8 -*-
#
# ogs6py documentation build configuration file, created by
...
from ogs6py import __version__ as ver
...
man_pages = [
    (master_doc, "ogs6py", "ogs6py Documentation", [author], 1)
]
